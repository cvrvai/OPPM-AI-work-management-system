...
export const modalShellClass = 'flex max-h-[92vh] w-[min(58rem,calc(100vw-0.5rem))] flex-col overflow-hidden rounded-2xl border border-border bg-white shadow-2xl sm:w-[min(58rem,calc(100vw-1rem))]'
export const secondaryButtonClass = 'rounded-lg border border-border px-3 py-1.5 text-sm font-medium text-text-secondary transition-colors hover:bg-surface-alt sm:px-4 sm:py-2'
export const primaryButtonClass = 'inline-flex items-center justify-center rounded-lg bg-primary px-4 py-1.5 text-sm font-semibold text-white transition-colors hover:bg-primary-dark disabled:opacity-50 sm:px-5 sm:py-2'
