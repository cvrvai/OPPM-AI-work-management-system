// Custom client configuration for @hey-api generated Intelligence SDK
// Wires the generated client to use our fetchWithSessionRetry for auth + token refresh

import { createClient, createConfig } from '@/generated/intelligence-api/client'
import { fetchWithSessionRetry } from '@/lib/api/sessionClient'
import type { ClientOptions } from '@/generated/intelligence-api/types.gen'
...
export const intelligenceClient = createClient(
