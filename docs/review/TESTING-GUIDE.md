...
- `frontend/package.json`
  - `npm run lint`
  - `npm run build`
- `services/workspace/tests/test_auth_enforcement.py`
...
```powershell
.\start_workspace.ps1
.\start_intelligence.ps1
.\start_integrations.ps1
...
```powershell
pytest services/workspace/tests/test_auth_enforcement.py
```
...
- gateway routing to intelligence, integrations, and automation services
