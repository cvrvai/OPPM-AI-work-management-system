...
- `services/mcp/infrastructure/mcp/tools/`

## Current Feature Ownership

| Feature group | Routes | Main files |
|---|---|---|
| Tool discovery | `GET /api/v1/workspaces/{workspace_id}/mcp/tools` | `routers/v1/mcp.py` |
| Tool execution | `POST /api/v1/workspaces/{workspace_id}/mcp/call` | `routers/v1/mcp.py` |
