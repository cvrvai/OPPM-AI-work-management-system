...
1. Extract TAOR loop iterations into graph nodes
   - Current file: `services/ai/infrastructure/rag/agent_loop.py`
   - Create: `services/ai/infrastructure/orchestration/graph_engine.py`
...
**Query changes:**
- New retriever: `services/ai/infrastructure/rag/retrievers/graph_retriever.py`
- Entity resolution: `services/ai/services/entity_resolver.py`
- Graph query builder: `services/ai/infrastructure/rag/graph_query_builder.py`
...
**Implementation:**
```python
# services/core/services/project_service.py (example)
...
**Implementation:**
```python
# services/ai/infrastructure/rag/retrievers/graph_retriever.py
...
- `docs/services/ai/README.md` — AI service overview
...
- `services/ai/routers/v1/ai_chat.py` — Chat endpoint implementation
- `services/ai/services/ai_chat_service.py` — Chat orchestration logic
- `services/ai/services/rag_service.py` — RAG pipeline implementation
- `services/ai/infrastructure/rag/agent_loop.py` — TAOR loop implementation
- `services/ai/infrastructure/tools/registry.py` — Tool registry
...
**Document ownership:** AI Service Team  
