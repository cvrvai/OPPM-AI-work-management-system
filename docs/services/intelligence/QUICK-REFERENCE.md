...
### New Documents (in `docs/services/intelligence/`)
...
### Updated Documents
1. **docs/services/intelligence/README.md**
...
**Files to create:**
- `services/intelligence/domains/analysis/entity_resolver.py` — resolve query text to entity IDs
- `services/intelligence/infrastructure/rag/retrievers/graph_retriever.py` — entity + path retrieval
- `services/intelligence/infrastructure/rag/graph_query_builder.py` — Cypher/query builder (if using Neo4j later)

**Files to enhance:**
- `services/intelligence/domains/document_indexer/service.py` — add `extract_graph_entities()`
- `services/intelligence/domains/rag/service.py` — integrate graph retrievers into RRF

**No changes to:**
- `services/intelligence/domains/chat/router.py` — backward compatible
- `services/intelligence/domains/chat/service.py` — no TAOR loop changes
...
📄 **Full Feasibility Analysis:** [`docs/services/intelligence/GRAPH-FEASIBILITY.md`](./GRAPH-FEASIBILITY.md)
- 37KB detailed report with architecture overview, assessments, effort/risk analysis, pilot scopes

📄 **Migration Decision Tree:** [`docs/services/intelligence/GRAPH-MIGRATION-PATHS.md`](./GRAPH-MIGRATION-PATHS.md)
- 17KB implementation roadmap with stages, checkpoints, go/no-go criteria, risk mitigation

📄 **Intelligence Service Overview:** [`docs/services/intelligence/README.md`](./README.md)
...
**Assessment completed by:** Intelligence Service Architect  
**Date:** 2026-04-21  
