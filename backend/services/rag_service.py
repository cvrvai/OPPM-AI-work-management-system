...
async def retrieve_with_rag_pipeline(
    ...
    Args:
        workspace_id: scope for data isolation.
        query: user's question.
        user_id: for loading conversation memory (optional).
        project_id: to scope/boost project-specific results (optional).
        top_k: number of final results.

    Returns:
        RAGResult with formatted context, source metadata, and memory.
    """
