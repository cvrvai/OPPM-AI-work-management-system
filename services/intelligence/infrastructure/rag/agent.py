...
_PATTERNS: list[tuple[re.Pattern, list[str]]] = [
    ...
    (re.compile(r"\b(block|depend|prerequisite|delay|wait.?for)", re.I), ["graph", "keyword"]),
    (re.compile(r"\b(overload|workload|capacity|how.?many.?tasks)", re.I), ["graph", "structured"]),
]
