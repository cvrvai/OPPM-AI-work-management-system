...
class TemplateReference:
    ...
    - Content templates (header text patterns)
    - Merge rules
    ...
    def get_content_template(self, row_name: str) -> str | None:
        """Get content template for a header row (row_1, row_2, etc.)."""
    ...
    def _parse_range(range_str: str) -> tuple[int, int, int, int]:
        ...
        if ":" not in range_str:
            ...
            return (row, TemplateReference._col_to_index(col), row, TemplateReference._col_to_index(col))
        ...
        return (
            start_row,
            TemplateReference._col_to_index(start_col),
            end_row,
            TemplateReference._col_to_index(end_col),
        )
