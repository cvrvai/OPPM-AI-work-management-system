...
async def list_tasks_route(
    ...
    return list_tasks(workspace_id=ws.workspace_id, project_id=project_id, status=status, limit=page_size, offset=offset)
...
async def get_task_route(task_id: str, ws: WorkspaceContext = Depends(get_workspace_context)):
    return get_task(task_id, workspace_id=ws.workspace_id)
