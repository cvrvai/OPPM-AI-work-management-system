"""
OPPM Tool Executor — Routes AI tool calls to the correct service/repo methods.
...
from domains.oppm.repository import ObjectiveRepository, TimelineRepository, CostRepository
...
async def execute_tool(
    ...
    Returns a dict with success/error/updated_entities.
    """
