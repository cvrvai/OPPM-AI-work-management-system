"""
Workspace Service — workspace, project, task, OPPM, notification, dashboard endpoints.
"""
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        version="2.0.0",
        description="Workspace service — workspaces, projects, tasks, OPPM, notifications, dashboard",
        lifespan=lifespan,
    )
