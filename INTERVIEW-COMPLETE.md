...
|------|---------|---|
| `services/core/routers/v1/` | API endpoint design | Clean REST patterns |
| `services/core/services/` | Business logic | 4-layer architecture |
| `services/core/repositories/` | Data access abstraction | Repository pattern |
...
- "How do you structure your code?" ✅ 4-layer clean architecture
